...
Comandos mais usados:<br/>
   ...
   23 - **docker network create < nome da rede que deseja> --subnet 192.168.134.0/24 --gateway  192.168.134.1**. Com esse comando você define criar a sua rede com um range de IP<br/>
   23 - ** **.<br/>
   23 - ** **.<br/>
